...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('CheckPage1')

WebUI.click(findTestObject('Object Repository/Page_Applitools/a_diff2'))

CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('CheckPage2')
